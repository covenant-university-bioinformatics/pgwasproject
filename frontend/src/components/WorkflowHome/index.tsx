  ...
  return (
    <div className={classes.custom_home}>
      ...
      <p className={classes.start_text}>
        The aim of this customized pipeline is to run multiple pGWAS tools in a
        single task. This customized pipeline consists of 8 individual pGWA
        ...
        of SNPs clumping step is select leads SNPs for the downstream analysis,
        i.e, its output used as input for the other 7 pipelines.
      </p>
      ...
      <p>
        ...
        required fields are: SNPs IDs (rsid), SNP chromosome (CHR), SNP position
        (BP), Reference allele (A1), Alternative (Minor) allele (A2),
        Alternative (Minor) allele frequency (freq), Beta (slope) value (beta),
        Standard error (slope_ser), p value (pval_nominal), Sample size (n), and
        Zscore (z). Population users should specify the population to calculate
        LD. Users can choose one of five 1000 genomes super populations, which
        are African (afr), American (amr), European (eur), East Asian (eas), and
        South Asian (sas).
      </p>
      ...
      <ol>
        <li>
          ...
          method indexes all SNPs that are significant at threshold of clump_p1
          then clumps of all other SNPs that are within a certain kb distance
          from the indexed SNPs.
        </li>
        ...
        <li>
          Users can specify to use annotated genes range (use_gene_region_file)
        </li>
        <li>
      ...
      <p>
        ...
        of Two Genetic Traits) to perform Bayesian fine-mapping analysis of the
        lead SNPs. Users can set values for the following parameters:
      </p>
      <ol type={"1"}>
        <li>
          p1, this parameter specifies the prior probability a SNP is associated
          with the trait. Before performing Bayesian fine-mapping, we normalize
          the value of p1 by the total SNPs number.
        </li>
        <li>
        ...
        <li>
          s, this parameter is required for a case-control GWAS summary dataset
          and it indicates the proportion of samples in the GWAS summary that
          are cases.
        </li>
      </ol>
      ...
      <ol type={"1"}>
        <li>
          A parameter to perform pathways analysis (runpathway). This parameter
          has two options: on, and off. If a user sets it to be off then this
          pipeline will just perform gene set based analysis.
        </li>
        <li>
        ...
        <li>
          Gene scoring method as either max or sum. The max gene scoring method
          is based on the maximum-of-chi-squares algorithm (MOCS), while the sum
          method is based on the sum-of-chi-squares (SOCS) algorithm.{" "}
        </li>
        <li>genomic distance in mega-bases.</li>
        <li>
          The minor allele frequency cutoff value (between 0 and 1). The default
          value is 0.05
        </li>
        <li>
      ...
      <ol type={"1"}>
        <li>
          ...
          <ol type={"a"}>
            ...
            <li>
              Drop, SNPs that have multiple synonyms in the data will be removed
              from the analysis
            </li>
            <li>
      ...
      <p>
        ...
        <a href="https://yanglab.westlake.edu.cn/software/smr/">SMR tool</a> to
        perform eQTL analysis based on two methods: SMR or HEIDI analysis. There
        are three types of analysis, which are:{" "}
      </p>
      <ol type={"1"}>
        <li>
          SMR <br />
          This helps to identify cis and trans eqtls in the summary staticstics.
          It mainly helps to identify genes whose expression levels are
          associated with the phenotype due to pleiotropy. The SMR p-value
          denotes this. The significance level is 8.4 * 10^-6 In the output file
          “.smr” we have the probe_id, probe_chr, gene name, gene base position,
          and the top eqtl SNP close to the position. The HEIDI p-value shows if
          the association is due to linkage or pleiotropy. A p-value less than
          0.05 shows association is due to pleiotropy.
        </li>
        <li>
          Trans SMR <br />
          This helps to identify cis and trans eqtls in the summary staticstics.
      ...
      <p>
        To run this pipeline, users can set values for the following parameters:
      </p>
      <ol type={"I"}>
        <li>
          General Parameters
        ...
        <li>
          ...
          <ol type={"1"}>
            ...
            <li>
              ...
              method and the value of 1 indicates the new HEIDI method.The
              default value is 1.
            </li>
            <li>
        ...
        <li>
          ...
          <p>
            ...
            value for trans window size (trans_wind). The default value is 1000
            Kb.
          </p>
        </li>
        <li>
      ...
      <p>
        The customized pipeline uses Annovar tool to perform deleteriousness and
        annotation analysis using the lead SNPs. Users can set values for the
        following parameters:
      </p>
      <ol type={"1"}>
        <li>Gene database (GENE_DB); users can choose "ucsc", or "ensembl".</li>
        <li>
          Performing Cytoband annotation (CYTOBAND); users can choose "true", or
          "false".
        </li>
        <li>
          Performing analysis using all 1000 genome populations (ALL); users can
          choose "true", or "false".
        </li>
        <li>
          Performing analysis using samples of African ancestries of 1000 genome
          populations (AFR); users can choose "true", or "false".
        </li>
        <li>
        ...
        <li>
          Performing annotation based on the gene-disease associations database
          (DISGENET); users can choose "true", or "false".
        </li>
        <li>
        ...
        <li>
          Performing annotation based on the Clinical Interpretation of genetic
          variants (INTERVAR); users can choose "true", or "false".
        </li>
      </ol>
      <h3>Parameters for regulatory SNPs annotations analysis</h3>
      <p>
        The customized pipeline uses HaploR R package to perform regulatory SNPs
        annotations using the lead SNPs.{" "}
      ...
      <ol type={"1"}>
        ...
        <li>
          ...
          model), imputed for querying ChromHMM (25-state model using 12 imputed
          marks), amd methyl for querying H3K4me1/H3K4me3 peaks and acetyl for
          querying H3K27ac/H3K9ac peaks.
        </li>
        <li>
          Mammalian conservation algorithm to be used (cons). There are three
          possible values for this parameter which are: gerp for GERP algorithm,
          siphy for SiPhy-omega algorithm, and both to use both algorithms.
        </li>
        <li>
      ...
      <ol type={"1"}>
        ...
        <li>
          F; This field will contain 1 indicating that there was one fileset. If
          users run the tool offline and use several GWAS summary then this
        ...
        <li>
          NSIG; indicating number of non significant clumped SNPs ( p &gt; 0.05
          )
        </li>
        <li>
      ...
      <p>
        The output of the Bayesian fine-mapping analysis contains the identified
        lead SNP with all fields of the input GWAS summary. However, there will
        be one more field contains the information of the probability of each
        SNPs to be causal, i.e the posterior probability that exactly that SNP
        is causal.
      </p>
      <h3>Pathway-based pGWAS analysis</h3>
      <p>
        The output of the pathway based analysis consists of a file of gene
        score results. In case the users choose to run pathways analysis, there
        will be more two files, which are:
      </p>
      <ul>
      ...
      <p>
        ...
        (EXAC). Clinvar, and Clinical Interpretation of genetic variants. Also,
        the output provides useful information, such allele frequencies and
        statistics of SNPs type.
      </p>
      <h3>Regulatory SNPs annotations analysis</h3>
      <p>
        The output of querying the HaploReg database will be reporte e annotated
        variants is plain tab delimited text file containing the following 35
        fields:
      </p>
      <ol>
        ...
        <li>
          is_query_snp: to indicate whether the SNP is queried or retrieved due
          to its LD with the queried SNP. The value of 0 indicates that the SNP
          is not queried while the value of 1 means the SNP is queried.
        </li>
        ...
        <li>
          EUR: to indicate the r2 value calculated for the European population.
        </li>
